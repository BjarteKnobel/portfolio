        ...
        <section className={styles.twoPhotoSection}>
          <div className={styles.twoPhotoWrap}>
            <div className={styles.photoItemLarge}>
              ...
              />
              <div className={styles.photoLargeCaption}>grasshopper was an essential tool to develop and test the project.</div>
            </div>
        ...
        <section className={styles.twoChartSection}>
          <div className={styles.twoChartWrap}>
            <div className={styles.chartItem}>
              ...
              />
              <div className={styles.photoLargeCaption}>stress before hardening of printed structure</div>
            </div>
            <div className={styles.chartItem}>
              <FadeInImage
                ...
                className={styles.chartImage}
              />
              <div className={styles.photoLargeCaption}>deformation before hardening of printed structure</div>
            </div>
      </div>
        </section>
      )}
